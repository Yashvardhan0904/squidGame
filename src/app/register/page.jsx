...
import { User, Mail, Eye, EyeOff, ArrowLeft, AlertCircle, Lock, ShieldCheck } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleGoogleClick = () => {
    ...
    if (window.google) {
      ...
      setError('Google sign-in is not configured yet. Please use email registration.');
    }
  };
      ...
      >
        ...
        <div className="bg-squid-card border border-squid-border/50 rounded-2xl p-7 shadow-2xl shadow-black/50">
          <div className="text-center mb-6">
            <h1 className="text-xl font-display font-bold text-white mb-1">Join the Arena</h1>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="block text-[10px] font-mono text-gray-500 tracking-[0.15em] uppercase mb-1.5">Name</label>
            ...
            <div>
              <label className="block text-[10px] font-mono text-gray-500 tracking-[0.15em] uppercase mb-1.5">Confirm Password</label>
              <div className="relative">
                <input type={showConfirmPassword ? 'text' : 'password'} value={confirmPassword}
                  onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Re-enter password" required minLength={6}
                  className="w-full bg-squid-gray border border-squid-border/50 text-white pl-10 pr-12 py-3 rounded-xl
                    font-mono text-sm focus:border-squid-pink/40 focus:outline-none transition-all placeholder:text-gray-700"
                />
                <ShieldCheck size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" />
          ...
          <div className="text-center mt-5">
            <p className="text-gray-600 text-sm">
              ...
              <a href="/login" className="text-squid-pink hover:underline font-medium">Login</a>
            </p>
          </div>
        </div>
